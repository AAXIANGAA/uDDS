...
UserDataType::UserDataType(const UserDataType &IDL_s){
  {
    char* IDL_elem1 = (char*)data;
    char* IDL_elem2 = (char*)IDL_s.data;
  ...
  }
  {
    ...
    for (unsigned long IDL_i = 0; IDL_i < 16; IDL_i++, IDL_elem1++,IDL_elem2++)
      *IDL_elem1 = *IDL_elem2;
  }
}
...
void UserDataType::Marshal(CDR *cdr) const {
...

  {
    ...
    for (unsigned long IDL_i = 0; IDL_i < 16; IDL_i++, IDL_elem++)
      cdr->PutChar((*IDL_elem));
  }
